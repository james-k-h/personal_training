      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <Link
              href="/"
              className="text-2xl font-bold text-black dark:text-yellow-400 transition-colors inline-block mb-4"
            >
              JKH Fitness
            </Link>
            <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed max-w-md">
              Your partner in achieving sustainable fitness goals through expert
              training, injury prevention, and holistic wellness. Building
              stronger, healthier communities since 2022.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="/about"
                  className="text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-yellow-400 text-sm transition-colors"
                >
                  About Us
                </Link>
              </li>
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-gray-600 dark:text-gray-400 text-sm">
            © 2026 JKH Fitness. All rights reserved.
          </p>
